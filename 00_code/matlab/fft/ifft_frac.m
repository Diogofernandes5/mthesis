function y_io = ifft_frac(y_io, N, stages, fractional_len)
    ...
    if N > 1
        ...
        ve = ifft_frac(ve, half_N, stages, fractional_len);
        vo = ifft_frac(vo, half_N, stages, fractional_len);
        ...
        for m = 1:half_N
            ...
            [fft_ve, fft_vo] = bf_operation_recursive(ve(m), vo(m), w, fractional_len);
            
            y_io(m) = fft_ve;                    % X0 = ve + w * vo
            y_io(m + half_N) = fft_vo;           % X1 = ve - w * vo
        end
    end
end