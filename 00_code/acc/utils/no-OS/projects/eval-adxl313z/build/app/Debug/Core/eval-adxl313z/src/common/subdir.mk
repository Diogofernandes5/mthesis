...
C_SRCS += \
../Core/eval-adxl313z/src/common/common_data.c 

OBJS += \
./Core/eval-adxl313z/src/common/common_data.o 

C_DEPS += \
./Core/eval-adxl313z/src/common/common_data.d 


# Each subdirectory must supply rules for building sources it contributes
Core/eval-adxl313z/src/common/%.o Core/eval-adxl313z/src/common/%.su: ../Core/eval-adxl313z/src/common/%.c Core/eval-adxl313z/src/common/subdir.mk
...
clean: clean-Core-2f-eval-2d-adxl313z-2f-src-2f-common

clean-Core-2f-eval-2d-adxl313z-2f-src-2f-common:
	-$(RM) ./Core/eval-adxl313z/src/common/common_data.d ./Core/eval-adxl313z/src/common/common_data.o ./Core/eval-adxl313z/src/common/common_data.su

.PHONY: clean-Core-2f-eval-2d-adxl313z-2f-src-2f-common
