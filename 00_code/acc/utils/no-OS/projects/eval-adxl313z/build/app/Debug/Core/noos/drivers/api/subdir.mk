...
C_SRCS += \
../Core/noos/drivers/api/no_os_gpio.c \
../Core/noos/drivers/api/no_os_i2c.c \
../Core/noos/drivers/api/no_os_irq.c \
../Core/noos/drivers/api/no_os_spi.c \
../Core/noos/drivers/api/no_os_uart.c 

OBJS += \
./Core/noos/drivers/api/no_os_gpio.o \
./Core/noos/drivers/api/no_os_i2c.o \
./Core/noos/drivers/api/no_os_irq.o \
./Core/noos/drivers/api/no_os_spi.o \
./Core/noos/drivers/api/no_os_uart.o 

C_DEPS += \
./Core/noos/drivers/api/no_os_gpio.d \
./Core/noos/drivers/api/no_os_i2c.d \
./Core/noos/drivers/api/no_os_irq.d \
./Core/noos/drivers/api/no_os_spi.d \
./Core/noos/drivers/api/no_os_uart.d 


# Each subdirectory must supply rules for building sources it contributes
Core/noos/drivers/api/%.o Core/noos/drivers/api/%.su: ../Core/noos/drivers/api/%.c Core/noos/drivers/api/subdir.mk
...
clean: clean-Core-2f-noos-2f-drivers-2f-api

clean-Core-2f-noos-2f-drivers-2f-api:
	-$(RM) ./Core/noos/drivers/api/no_os_gpio.d ./Core/noos/drivers/api/no_os_gpio.o ./Core/noos/drivers/api/no_os_gpio.su ./Core/noos/drivers/api/no_os_i2c.d ./Core/noos/drivers/api/no_os_i2c.o ./Core/noos/drivers/api/no_os_i2c.su ./Core/noos/drivers/api/no_os_irq.d ./Core/noos/drivers/api/no_os_irq.o ./Core/noos/drivers/api/no_os_irq.su ./Core/noos/drivers/api/no_os_spi.d ./Core/noos/drivers/api/no_os_spi.o ./Core/noos/drivers/api/no_os_spi.su ./Core/noos/drivers/api/no_os_uart.d ./Core/noos/drivers/api/no_os_uart.o ./Core/noos/drivers/api/no_os_uart.su

.PHONY: clean-Core-2f-noos-2f-drivers-2f-api
