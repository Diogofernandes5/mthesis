...
clf;
semilogx(iec_f, ds_dB, '-g', 'linewidth', 2, 'DisplayName', 'ICS-43434 Datasheet plot (approx.)');
...
sm = semilogx(iec_f, iec_c1_t_dB, iec_f, iec_c1_b_dB, '--r', 'linewidth', 2, 'DisplayName', 'IEC 61672-1:2013 Class 1 tolerance');
%semilogx(iec_f, iec_c1_b_dB,  '--r', 'linewidth', 2);
semilogx(iec_f, iec_c2_t_dB, iec_f, iec_c2_b_dB, '-r', 'linewidth', 2, 'DisplayName', 'IEC 61672-1:2013 Class 2 tolerance');
%semilogx(iec_f, iec_c2_b_dB,  '-r', 'linewidth', 2);
semilogx(iec_f, 20*log10(abs(ds_H)), '--c', 'linewidth', 2, 'DisplayName', 'IIR filter frequency response');
semilogx(iec_f, (ds_dB + 20*log10(abs(eq_H))), '-b', 'linewidth', 4, 'DisplayName', 'Adjusted frequency response');

%legend({'ICS-43434 Datasheet plot (approx.)', 'IEC 61672-1:2013 Class 1 tolerance',...
 %   'IEC 61672-1:2013 Class 1 toleranceb', 'IEC 61672-1:2013 Class 2 tolerance', 'IEC 61672-1:2013 Class 2 toleranceb',...
  %  'IIR filter frequency response', 'Adjusted frequency response'});
  
legend;
%    'Visible' , {'on', 'on','off','on','off','on','on'});
%legend('ICS-43434 Datasheet plot (approx.)', class1linet_leg, class1lineb_leg, class2linet_leg, class2lineb_leg, 'IIR filter frequency response', 'Adjusted frequency response');
hold off;
