...
void check_sequence(int *data, size_t count) {
	uint32_t error = 0;
...
int main(int argc, char *args[]){
	...
	const char* GOLDEN_RE_FILENAME = "/home/fernandes/thesis/00_code/matlab/golden_vectors/cwt/golden_re.txt";
	const char* GOLDEN_IM_FILENAME = "/home/fernandes/thesis/00_code/matlab/golden_vectors/cwt/golden_im.txt";
	...
	golden_vect = read_golden_file(GOLDEN_RE_FILENAME, GOLDEN_IM_FILENAME, 2048);
