...
#
# Generated by export_simulation on Thu Nov 07 16:19:10 WET 2024
#
################################################################################
...
'-reset_run' switch to the './fft_data_path_1.sh' script.

./fft_data_path_1.sh -reset_run
...
./fft_data_path_1.sh -noclean_files

For more information on the script, please type './fft_data_path_1.sh -help'.
