...
#
# Generated by export_simulation on Sun Nov 10 01:36:41 WET 2024
#
################################################################################
...
'-reset_run' switch to the './fft_control_unit_1.sh' script.

./fft_control_unit_1.sh -reset_run
...
./fft_control_unit_1.sh -noclean_files

For more information on the script, please type './fft_control_unit_1.sh -help'.
