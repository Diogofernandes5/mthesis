...
##Pmod Header JD
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33     } [get_ports { SPI_clk_o }]; #IO_L5P_T0_34 Sch=jd_p[1]
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33     } [get_ports { SPI_MOSI_o }]; #IO_L5N_T0_34 Sch=jd_n[1]
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33     } [get_ports { SPI_MISO_i }]; #IO_L6P_T0_34 Sch=jd_p[2]
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33     } [get_ports { SPI_CS_o }]; #IO_L6N_T0_VREF_34 Sch=jd_n[2]
#set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33     } [get_ports { acc_int }]; #IO_L11P_T1_SRCC_34 Sch=jd_p[3]
...
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33     } [get_ports { data_ready }]; #IO_L21N_T3_DQS_34 Sch=jd_n[4]


##Pmod Header JE
#set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports SPI_clk_o]
...
#set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS33} [get_ports SPI_CS_o]
...
#set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33} [get_ports data_ready]
