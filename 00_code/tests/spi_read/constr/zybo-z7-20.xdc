...
##Pmod Header JD                                                                                                                  
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33     } [get_ports { SPI_CS_o }]; #IO_L5P_T0_34 Sch=jd_p[1]                  
...
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33     } [get_ports { SPI_clk_o }]; #IO_L6N_T0_VREF_34 Sch=jd_n[2]             
...
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33     } [get_ports { intr_i }]; #IO_L21N_T3_DQS_34 Sch=jd_n[4]             
