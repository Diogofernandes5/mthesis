...
module butterfly_full(
    ...
    input [32-1:0] x0_re_i,
    input [32-1:0] x0_im_i,
    input [32-1:0] x1_re_i,
    input [32-1:0] x1_im_i,
    input [32-1:0] w_re_i,
    input [32-1:0] w_im_i,
    
    output wire [32-1:0] X0_re_o,
    output wire [32-1:0] X0_im_o,
    output wire [32-1:0] X1_re_o,
    output wire [32-1:0] X1_im_o
    
//    output wire [32-1:0] x1_re_x_w_re,
//    output wire [32-1:0] x1_im_x_w_im,
//    output wire [32-1:0] x1_re_x_w_im,
//    output wire [32-1:0] x1_im_x_w_re
    
//    output wire [32*2-1:0] z_re,
//    output wire [32*2-1:0] z_im,
...
//    output wire z_im_add_v
    ...
    wire [32-1:0] x1_re_x_w_re_m;
    wire [32-1:0] x1_im_x_w_im_m;
    wire [32-1:0] x1_im_x_w_re_m;
    wire [32-1:0] x1_re_x_w_im_m;
        
    // multiplication results after invert 
//    wire [32-1:0] x1_re_x_w_re;
//    wire [32-1:0] x1_im_x_w_im;
//    wire [32-1:0] x1_re_x_w_im;
//    wire [32-1:0] x1_im_x_w_re;
