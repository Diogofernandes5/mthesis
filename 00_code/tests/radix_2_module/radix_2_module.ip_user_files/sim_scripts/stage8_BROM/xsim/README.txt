...
#
# Generated by export_simulation on Thu Mar 28 12:15:20 WET 2024
#
################################################################################
...
'-reset_run' switch to the './stage8_BROM.sh' script.

./stage8_BROM.sh -reset_run
...
./stage8_BROM.sh -noclean_files

For more information on the script, please type './stage8_BROM.sh -help'.
