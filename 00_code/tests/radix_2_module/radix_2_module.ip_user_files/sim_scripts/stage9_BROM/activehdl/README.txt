...
#
# Generated by export_simulation on Thu Mar 28 12:16:14 WET 2024
#
################################################################################
...
'-reset_run' switch to the './stage9_BROM.sh' script.

./stage9_BROM.sh -reset_run
...
./stage9_BROM.sh -noclean_files

For more information on the script, please type './stage9_BROM.sh -help'.
