...
#
# Generated by export_simulation on Thu Mar 28 12:12:33 WET 2024
#
################################################################################
...
'-reset_run' switch to the './stage7_BROM.sh' script.

./stage7_BROM.sh -reset_run
...
./stage7_BROM.sh -noclean_files

For more information on the script, please type './stage7_BROM.sh -help'.
