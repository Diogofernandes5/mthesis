...
#
# Generated by export_simulation on Thu Mar 28 11:40:55 WET 2024
#
################################################################################
...
'-reset_run' switch to the './stage6_BROM.sh' script.

./stage6_BROM.sh -reset_run
...
./stage6_BROM.sh -noclean_files

For more information on the script, please type './stage6_BROM.sh -help'.
