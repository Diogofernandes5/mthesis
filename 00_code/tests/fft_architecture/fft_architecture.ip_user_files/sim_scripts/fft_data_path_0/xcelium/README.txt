...
#
# Generated by export_simulation on Fri May 24 13:49:19 WEST 2024
#
################################################################################
...
'-reset_run' switch to the './fft_data_path_0.sh' script.

./fft_data_path_0.sh -reset_run
...
./fft_data_path_0.sh -noclean_files

For more information on the script, please type './fft_data_path_0.sh -help'.
