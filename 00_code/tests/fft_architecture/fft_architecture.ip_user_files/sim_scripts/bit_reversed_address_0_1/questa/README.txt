...
#
# Generated by export_simulation on Mon Nov 11 17:27:28 WET 2024
#
################################################################################
...
'-reset_run' switch to the './bit_reversed_address_0.sh' script.

./bit_reversed_address_0.sh -reset_run
...
./bit_reversed_address_0.sh -noclean_files

For more information on the script, please type './bit_reversed_address_0.sh -help'.
