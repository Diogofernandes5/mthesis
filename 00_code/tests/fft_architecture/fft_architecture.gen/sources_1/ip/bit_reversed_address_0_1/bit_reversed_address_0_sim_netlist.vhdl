...
--               /home/fernandes/thesis/00_code/tests/fft_architecture/fft_architecture.gen/sources_1/ip/bit_reversed_address_0_1/bit_reversed_address_0_sim_netlist.vhdl
...
entity bit_reversed_address_0 is
  port (
    index_i : in STD_LOGIC_VECTOR ( 3 downto 0 );
    reversed_o : out STD_LOGIC_VECTOR ( 3 downto 0 )
  );
...
architecture STRUCTURE of bit_reversed_address_0 is
  signal \^index_i\ : STD_LOGIC_VECTOR ( 3 downto 0 );
begin
  \^index_i\(3 downto 0) <= index_i(3 downto 0);
  reversed_o(3) <= \^index_i\(0);
  reversed_o(2) <= \^index_i\(1);
  reversed_o(1) <= \^index_i\(2);
  reversed_o(0) <= \^index_i\(3);
end STRUCTURE;
