...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_M_AXI_TARGET_SLAVE_BASE_ADDR"
  ipgui::add_param $IPINST -name "C_M_AXI_BURST_LEN" -widget comboBox
  ...
  ipgui::add_param $IPINST -name "C_M_CACHE_VAL"
  ipgui::add_param $IPINST -name "C_M_PROT_VAL"

}

proc update_PARAM_VALUE.C_M_CACHE_VAL { PARAM_VALUE.C_M_CACHE_VAL } {
	# Procedure called to update C_M_CACHE_VAL when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_CACHE_VAL { PARAM_VALUE.C_M_CACHE_VAL } {
	# Procedure called to validate C_M_CACHE_VAL
	return true
}

proc update_PARAM_VALUE.C_M_PROT_VAL { PARAM_VALUE.C_M_PROT_VAL } {
	# Procedure called to update C_M_PROT_VAL when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_PROT_VAL { PARAM_VALUE.C_M_PROT_VAL } {
	# Procedure called to validate C_M_PROT_VAL
	return true
}
...
proc update_MODELPARAM_VALUE.C_M_CACHE_VAL { MODELPARAM_VALUE.C_M_CACHE_VAL PARAM_VALUE.C_M_CACHE_VAL } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_CACHE_VAL}] ${MODELPARAM_VALUE.C_M_CACHE_VAL}
}

proc update_MODELPARAM_VALUE.C_M_PROT_VAL { MODELPARAM_VALUE.C_M_PROT_VAL PARAM_VALUE.C_M_PROT_VAL } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_PROT_VAL}] ${MODELPARAM_VALUE.C_M_PROT_VAL}
}
