...
--               /home/fernandes/thesis/00_code/ip/cwt/bd/cwt_bd/ip/cwt_bd_axi_master_full_0_0/cwt_bd_axi_master_full_0_0_sim_netlist.vhdl
...
entity cwt_bd_axi_master_full_0_0_axi_master_full_v1_0_M_AXI is
  port (
  ...
  attribute ORIG_REF_NAME of cwt_bd_axi_master_full_0_0_axi_master_full_v1_0_M_AXI : entity is "axi_master_full_v1_0_M_AXI";
end cwt_bd_axi_master_full_0_0_axi_master_full_v1_0_M_AXI;

architecture STRUCTURE of cwt_bd_axi_master_full_0_0_axi_master_full_v1_0_M_AXI is
  ...
  signal write_burst_counter : STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  attribute SOFT_HLUTNM of axi_awvalid_i_1 : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of error_reg_i_3 : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \read_burst_counter[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \read_burst_counter[2]_i_1\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \read_index[6]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \read_index[7]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \read_index[8]_i_3\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of reads_done_i_2 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \write_burst_counter[0]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \write_burst_counter[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \write_burst_counter[2]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \write_index[7]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \write_index[8]_i_3\ : label is "soft_lutpair8";
...
\axi_araddr_reg[31]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 2) => B"00",
      S(1 downto 0) => \^m_axi_araddr\(21 downto 20)
    );
...
\write_burst_counter[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FF7F0080"
    )
        port map (
      ...
      I3 => p_0_in3_in,
      I4 => write_burst_counter(1),
      O => \write_burst_counter[1]_i_1_n_0\
    );
\write_burst_counter[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFF8000"
    )
        port map (
      I0 => write_burst_counter(1),
      I1 => write_burst_counter(0),
      I2 => m_axi_awready,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cwt_bd_axi_master_full_0_0_axi_master_full_v1_0 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of cwt_bd_axi_master_full_0_0_axi_master_full_v1_0 : entity is "axi_master_full_v1_0";
end cwt_bd_axi_master_full_0_0_axi_master_full_v1_0;

architecture STRUCTURE of cwt_bd_axi_master_full_0_0_axi_master_full_v1_0 is
begin
axi_master_full_v1_0_M_AXI_inst: entity work.cwt_bd_axi_master_full_0_0_axi_master_full_v1_0_M_AXI
     port map (
      M_AXI_BREADY => M_AXI_BREADY,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cwt_bd_axi_master_full_0_0 is
  port (
    m_axi_init_axi_txn : in STD_LOGIC;
    m_axi_txn_done : out STD_LOGIC;
    m_axi_error : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of cwt_bd_axi_master_full_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of cwt_bd_axi_master_full_0_0 : entity is "cwt_bd_axi_master_full_0_0,axi_master_full_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of cwt_bd_axi_master_full_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of cwt_bd_axi_master_full_0_0 : entity is "axi_master_full_v1_0,Vivado 2021.1";
end cwt_bd_axi_master_full_0_0;

architecture STRUCTURE of cwt_bd_axi_master_full_0_0 is
  signal \<const0>\ : STD_LOGIC;
  signal \<const1>\ : STD_LOGIC;
  signal \^m_axi_araddr\ : STD_LOGIC_VECTOR ( 31 downto 10 );
  signal \^m_axi_awaddr\ : STD_LOGIC_VECTOR ( 31 downto 10 );
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of m_axi_aclk : signal is "xilinx.com:signal:clock:1.0 M_AXI_CLK CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of m_axi_aclk : signal is "XIL_INTERFACENAME M_AXI_CLK, ASSOCIATED_BUSIF M_AXI, ASSOCIATED_RESET m_axi_aresetn, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN cwt_bd_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
...
begin
  ...
  m_axi_awaddr(31 downto 10) <= \^m_axi_awaddr\(31 downto 10);
...
inst: entity work.cwt_bd_axi_master_full_0_0_axi_master_full_v1_0
     port map (
      M_AXI_BREADY => m_axi_bready,
      ...
      m_axi_aclk => m_axi_aclk,
      m_axi_araddr(21 downto 0) => \^m_axi_araddr\(31 downto 10),
      m_axi_aresetn => m_axi_aresetn,
      m_axi_arready => m_axi_arready,
      m_axi_awaddr(21 downto 0) => \^m_axi_awaddr\(31 downto 10),
      m_axi_awready => m_axi_awready,
