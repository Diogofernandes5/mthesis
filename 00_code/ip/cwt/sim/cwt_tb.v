...
reg [31:0] golden_cwt_re_buf[0:(N*J1)-1];
reg [31:0] golden_cwt_im_buf[0:(N*J1)-1];
reg [31:0] output_cwt_re_buf[0:(N*J1)-1];
reg [31:0] output_cwt_im_buf[0:(N*J1)-1];
...
integer i_out_cwt;  // num iterations
integer counter_j_mul;
integer counter_j_ifft;
integer counter_j_cwt;
...
localparam CWT_GOLDEN_RE_FN = "/home/fernandes/thesis/00_code/matlab/golden_vectors/cwt/golden_re.txt";
localparam CWT_GOLDEN_IM_FN = "/home/fernandes/thesis/00_code/matlab/golden_vectors/cwt/golden_im.txt";
localparam CWT_OUTPUT_RE_FN = "/home/fernandes/thesis/00_code/matlab/golden_vectors/cwt/output_re.txt";
localparam CWT_OUTPUT_IM_FN = "/home/fernandes/thesis/00_code/matlab/golden_vectors/cwt/output_im.txt";
