...
-- Date        : Mon Nov  4 19:35:48 2024
-- Host        : fernandes420 running 64-bit Ubuntu 22.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/fernandes/thesis/00_code/ip/fft_data_path/data_path/data_path.gen/sources_1/ip/fft_control_unit_0_1/fft_control_unit_0_sim_netlist.vhdl
...
architecture STRUCTURE of fft_control_unit_0_divu_int is
  ...
  signal \quo[3]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \val[1]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \b1[2]_i_1\ : label is "soft_lutpair3";
...
\b1[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"DDDF8888"
    )
        port map (
...
\b1[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F5F7A0A0"
    )
        port map (
...
\b1[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FF57AA00"
    )
        port map (
...
\quo[0]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FEFFFE00"
    )
        port map (
...
\quo[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EFE0"
    )
        port map (
...
quo_next1_carry_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F2"
    )
        port map (
...
quo_next1_carry_i_7: unisim.vcomponents.LUT3
    generic map(
      INIT => X"09"
    )
        port map (
...
\val[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
entity fft_control_unit_0_control_unit is
  port (
    ...
    bram_addr_x0_o : out STD_LOGIC_VECTOR ( 2 downto 0 );
    bram_addr_x1_o : out STD_LOGIC_VECTOR ( 2 downto 0 );
    bram_x0_we_o : out STD_LOGIC;
    bram_x1_we_o : out STD_LOGIC;
    bram_x0_en_o : out STD_LOGIC;
    bram_x1_en_o : out STD_LOGIC;
    twiddle_addr_o : out STD_LOGIC_VECTOR ( 1 downto 0 );
    state : out STD_LOGIC_VECTOR ( 3 downto 0 );
    data_counter : out STD_LOGIC_VECTOR ( 3 downto 0 )
  );
  ...
  attribute BRAM_SIZE of fft_control_unit_0_control_unit : entity is 8;
  ...
  attribute HALF_N of fft_control_unit_0_control_unit : entity is 4;
  attribute N : integer;
  attribute N of fft_control_unit_0_control_unit : entity is 8;
  attribute ORIG_REF_NAME : string;
...
architecture STRUCTURE of fft_control_unit_0_control_unit is
  ...
  signal bram_addr_x0 : STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  signal bram_addr_x1 : STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  signal NLW_staged_half_N_div_val_UNCONNECTED : STD_LOGIC_VECTOR ( 9 downto 2 );
  attribute SOFT_HLUTNM : string;
  ...
  attribute SOFT_HLUTNM of bf_ce_o_INST_0 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \bf_counter[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \bf_counter[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \bf_counter[2]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \bf_cycle_counter[0]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \bf_cycle_counter[1]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \bf_cycle_counter[2]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \bf_cycle_counter[3]_i_2\ : label is "soft_lutpair8";
  attribute XILINX_LEGACY_PRIM : string;
  attribute XILINX_LEGACY_PRIM of \bram_addr_x0_o_reg[0]\ : label is "LD";
  attribute SOFT_HLUTNM of \bram_addr_x0_o_reg[0]_i_1\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \bram_addr_x1_o_reg[1]_i_1\ : label is "soft_lutpair26";
  attribute XILINX_LEGACY_PRIM of \bram_addr_x1_o_reg[2]\ : label is "LD";
  attribute SOFT_HLUTNM of \bram_addr_x1_o_reg[2]_i_1\ : label is "soft_lutpair26";
  ...
  attribute SOFT_HLUTNM of \data_counter[0]_i_1\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \div_bf_cycle_counter[0]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \div_bf_cycle_counter[1]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \div_bf_cycle_counter[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \div_bf_cycle_counter[3]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of fft_ready_o_i_1 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \group_size[0]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \group_size[1]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \group_size[2]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \group_start[1]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \group_start[2]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \local_index[0]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \local_index[1]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \stage_counter[0]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \stage_counter[2]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \stage_counter[3]_i_2\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \state[0]_INST_0\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \state[1]_INST_0\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \state[2]_INST_0\ : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of \twiddle_addr_o_reg[1]_i_1\ : label is "soft_lutpair15";
begin
  bf_ce_o <= \^bf_ce_o\;
  bram_x1_en_o <= \^bram_x1_en_o\;
  bram_x1_we_o <= \^bram_x1_we_o\;
  data_counter(3 downto 0) <= \^data_counter\(3 downto 0);
  state(3) <= \^state\(3);
  state(2) <= \^bram_x1_en_o\;
  state(1 downto 0) <= \^state\(1 downto 0);
  twiddle_addr_o(1 downto 0) <= \^twiddle_addr_o\(1 downto 0);
...
\bf_counter[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0001CCCC"
    )
        port map (
...
\bf_counter[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"50505053A0A0A0A0"
    )
        port map (
      I0 => \bf_counter_reg_n_0_[0]\,
      I1 => \FSM_onehot_state_reg_n_0_[4]\,
...
\bf_counter[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"4CFF8000"
    )
        port map (
...
\bf_counter[2]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\bram_addr_x0_o_reg[0]\: unisim.vcomponents.LDCE
    generic map(
      ...
      G => \bram_addr_x0_o_reg[2]_i_2_n_0\,
      GE => '1',
      Q => bram_addr_x0_o(0)
    );
...
bram_addr_x1_adder: entity work.fft_control_unit_0_adder_subtracter32bit
     port map (
      c_in => '0',
      r(31 downto 3) => NLW_bram_addr_x1_adder_r_UNCONNECTED(31 downto 3),
      r(2 downto 0) => bram_addr_x1(2 downto 0),
      v => NLW_bram_addr_x1_adder_v_UNCONNECTED,
      x(31 downto 3) => B"00000000000000000000000000000",
      x(2 downto 0) => bram_addr_x0(2 downto 0),
      y(31 downto 3) => B"00000000000000000000000000000",
      y(2 downto 0) => group_size(2 downto 0)
    );
...
bram_addr_xo_adder: entity work.\fft_control_unit_0_adder_subtracter32bit__1\
     port map (
      c_in => '0',
      r(31 downto 3) => NLW_bram_addr_xo_adder_r_UNCONNECTED(31 downto 3),
      r(2 downto 0) => bram_addr_x0(2 downto 0),
      v => NLW_bram_addr_xo_adder_v_UNCONNECTED,
      x(31 downto 3) => B"00000000000000000000000000000",
      x(2 downto 1) => group_start(2 downto 1),
      x(0) => '0',
      y(31 downto 2) => B"000000000000000000000000000000",
      y(1 downto 0) => local_index(1 downto 0)
    );
...
fft_ready_o_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FF00FE00"
    )
        port map (
...
staged_half_N_div: entity work.fft_control_unit_0_div_10bit
     port map (
      a(9 downto 0) => B"0000000100",
      b(9 downto 3) => B"0000000",
      b(2 downto 0) => group_size(2 downto 0),
      ...
      val(9 downto 2) => NLW_staged_half_N_div_val_UNCONNECTED(9 downto 2),
      val(1 downto 0) => staged_half_N(1 downto 0),
...
\twiddle_addr_o_reg[0]\: unisim.vcomponents.LDCE
    generic map(
      ...
      G => \twiddle_addr_o_reg[1]_i_2_n_0\,
      GE => '1',
      Q => \^twiddle_addr_o\(0)
    );
...
\twiddle_addr_o_reg[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
      ...
      I4 => \FSM_onehot_state_reg_n_0_[3]\,
      I5 => \FSM_onehot_state_reg_n_0_[2]\,
      O => \twiddle_addr_o_reg[1]_i_2_n_0\
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
architecture STRUCTURE of fft_control_unit_0 is
  ...
  attribute BRAM_SIZE : integer;
  attribute BRAM_SIZE of inst : label is 8;
  attribute DIV_CYCLES : string;
  attribute DIV_CYCLES of inst : label is "4'b1011";
  attribute FIRST_STAGE : integer;
  attribute FIRST_STAGE of inst : label is 0;
  attribute HALF_N : integer;
  attribute HALF_N of inst : label is 4;
  attribute N : integer;
  attribute N of inst : label is 8;
  attribute STAGES_NUM : integer;
...
inst: entity work.fft_control_unit_0_control_unit
     port map (
      bf_ce_o => bf_ce_o,
      bram_addr_x0_o(2 downto 0) => bram_addr_x0_o(2 downto 0),
      bram_addr_x1_o(2 downto 0) => bram_addr_x1_o(2 downto 0),
