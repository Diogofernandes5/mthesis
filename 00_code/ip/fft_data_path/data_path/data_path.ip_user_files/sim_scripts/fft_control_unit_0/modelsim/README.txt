...
#
# Generated by export_simulation on Wed Aug 07 12:10:19 WEST 2024
#
################################################################################
...
'-reset_run' switch to the './fft_control_unit_0.sh' script.

./fft_control_unit_0.sh -reset_run
...
./fft_control_unit_0.sh -noclean_files

For more information on the script, please type './fft_control_unit_0.sh -help'.
