...
#
# Generated by export_simulation on Wed Apr 03 11:46:35 WEST 2024
#
################################################################################
...
'-reset_run' switch to the './butterfly_full_0.sh' script.

./butterfly_full_0.sh -reset_run
...
./butterfly_full_0.sh -noclean_files

For more information on the script, please type './butterfly_full_0.sh -help'.
