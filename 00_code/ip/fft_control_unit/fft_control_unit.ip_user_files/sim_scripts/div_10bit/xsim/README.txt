...
#
# Generated by export_simulation on Thu Oct 31 11:36:40 WET 2024
#
################################################################################
...
'-reset_run' switch to the './div_10bit.sh' script.

./div_10bit.sh -reset_run
...
./div_10bit.sh -noclean_files

For more information on the script, please type './div_10bit.sh -help'.
