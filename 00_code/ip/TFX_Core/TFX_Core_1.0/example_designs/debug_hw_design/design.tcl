...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of TFX_Core_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins TFX_Core_0/S_AXI_Config]
	connect_bd_net [get_bd_pins TFX_Core_0/s_axi_config_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins TFX_Core_0/s_axi_config_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock, reset & status pins of TFX_Core_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins TFX_Core_0/M_AXI_Data]
	connect_bd_net [get_bd_pins TFX_Core_0/m_axi_data_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins TFX_Core_0/m_axi_data_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins TFX_Core_0/m_axi_data_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins TFX_Core_0/m_axi_data_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins TFX_Core_0/m_axi_data_init_axi_txn] [ get_bd_pins axi_gpio_out/gpio_io_o ]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of TFX_Core_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {TFX_Core_0/M_AXI_Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_M_AXI_Data_TARGET_SLAVE_BASE_ADDR {0xC0000000} ] [get_bd_cells TFX_Core_0]

	# Copy all address to TFX_Core_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/TFX_Core_v1_0_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_TFX_Core_0_S_AXI_Config_* ]]
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/TFX_Core_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "TFX_Core_v1_0_hw_${i}"
